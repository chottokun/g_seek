...
from deep_research_project.core.prompts import (
    ...
    SYNTHESIZE_SUMMARY_PROMPT_JA, SYNTHESIZE_SUMMARY_PROMPT_EN,
...
class ResearchExecutor:
    ...
    async def retrieve_and_summarize(self, results: List[SearchResult], query: str, 
        ...
        if language == "Japanese":
            prompt = SYNTHESIZE_SUMMARY_PROMPT_JA.format(query=query, combined_summaries=combined)
        else:
            prompt = SYNTHESIZE_SUMMARY_PROMPT_EN.format(query=query, combined_summaries=combined)
