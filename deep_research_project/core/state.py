...
class ResearchState:
    ...
    def to_dict(self) -> Dict:
        """Serializes the ResearchState to a dictionary."""
        return {
    ...
    def from_dict(cls, data: Dict) -> 'ResearchState':
        """Deserializes a dictionary into a ResearchState object."""
        state = cls(research_topic=data.get("research_topic", ""), language=data.get("language", "Japanese"))
