...
class ResearchLoop:
    ...
    def format_follow_up_prompt(self, final_report: str, question: str) -> str:
        ...
        if self.state.language == "Japanese":
            return FOLLOW_UP_PROMPT_JA.format(final_report=final_report, question=question)
        else:
            return FOLLOW_UP_PROMPT_EN.format(final_report=final_report, question=question)
